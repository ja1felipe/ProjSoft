...
import psoft.lab02.entities.disciplina.DisciplinaDTO;
...
public class DisciplinaController {
    ...
    public ResponseEntity<Disciplina> updateNota(@RequestParam Long id, @RequestBody DisciplinaDTO dto){
        Disciplina d = discService.updateNota(id, dto.getNota());
        return new ResponseEntity<>(d, HttpStatus.OK);
    }

    @PostMapping("api/disciplinas/{id}/comentarios")
    public ResponseEntity<Disciplina> addComent(@RequestParam Long id, @RequestBody DisciplinaDTO dto){
